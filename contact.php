                    ...
                    <div class="row py-4">
                        <div class="col-lg-6">
                            ...
                            <div class="overflow-hidden mb-1">
                                <h2 class="font-weight-normal text-7 mt-2 mb-0 appear-animation animated maskUp appear-animation-visible" data-appear-animation="maskUp" data-appear-animation-delay="200" style="animation-delay: 200ms;">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="appear-animation animated fadeIn appear-animation-visible" data-appear-animation="fadeIn" data-appear-animation-delay="800" style="animation-delay: 800ms;">
                                ...
                                <ul class="list list-icons list-icons-style-2 mt-2">
                                    ...
                                    <li>
                                        ...
                                        <a href="mailto:mail@example.com">sensha.nepal@gmail.com</a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <h4 class="pt-5">Follow us
                                <strong>on</strong>
                            </h4>
                            <ul class="footer-social-icons social-icons social-icons-clean social-icons-big social-icons-opacity-light social-icons-icon-light mt-1">
                                <li class="social-icons-facebook  contact-icon">
                                    <a href="http://www.facebook.com/" target="_blank" title="Facebook">
                                        <i class="fab fa-facebook-f"></i>
                                    </a>
                                </li>
                                <li class="social-icons-twitter  contact-icon">
                                    <a href="http://www.instagram.com/" target="_blank" title="Twitter">
                                        <i class="fab fa-instagram"></i>
                                    </a>
                                </li>
                                <li class="social-icons-linkedin  contact-icon">
