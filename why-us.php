                    ...
                    <div class="container">
                        <div class="row mt-5">
                            <div class="col-md-12 align-self-center p-static order-2 text-center">
                                <h1 class="text-9 font-weight-bold">SENSHA Glass Coating
                                </h1>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                        ...
                        <div class="tabs tabs-vertical tabs-left tabs-navigation">
                            <ul class="nav nav-tabs col-sm-3">
                                <li class="nav-item active">
                                    <a class="nav-link active" href="#tabsNavigation1" data-toggle="tab">
                                        What is SENSHA Glass Coating?
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#tabsNavigation2" data-toggle="tab">
                                        8 Glass Coating Features</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#tabsNavigation3" data-toggle="tab">
                                        Japanese Industrial Standards (JIS) Certified
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#tabsNavigation4" data-toggle="tab">
                                        How Glass Coating Layer is established
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#tabsNavigation5" data-toggle="tab">
                                        The Gloss</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#tabsNavigation6" data-toggle="tab">
                                        Part Specific Glass Coating
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#tabsNavigation7" data-toggle="tab">
                                        Maintenance Glass Coating
                                    </a>
                                </li>
                    ...
                    <div class="col-lg-8">
                        <div class="tab-pane tab-pane-navigation active" id="tabsNavigation1">
                            <h4>What is SENSHA Glass Coating?
                            </h4>
                            <img src="https://sensha-nepal.com/wp-content/uploads/2020/01/top-img.png" class="img-fluid img-thumbnail img-thumbnail-no-borders rounded-0 mt-1 pb-1" alt="">
                            <p class="mt-1">SENSHA Glass Coating was researched and developed to form the glass coating layer on your car without professional experiences. SENSHA Glass Coating is ideal for car owners who experience difficulties and/or spending too much time on using car wax, as well as car owners who consider having professional car coating from car dealers or detailing shops.</p>
                        </div>
                        <div class="tab-pane tab-pane-navigation" id="tabsNavigation2"></div>
                        <div class="tab-pane tab-pane-navigation" id="tabsNavigation3"></div>
                        <div class="tab-pane tab-pane-navigation" id="tabsNavigation4"></div>
                        <div class="tab-pane tab-pane-navigation" id="tabsNavigation5"></div>
                        <div class="tab-pane tab-pane-navigation" id="tabsNavigation6"></div>
                        <div class="tab-pane tab-pane-navigation" id="tabsNavigation7"></div>
                    </div>
                </div>
            </div>
        </div>
